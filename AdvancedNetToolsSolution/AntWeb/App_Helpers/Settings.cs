...
namespace SmartAdminMvc
{
    ...
    public static class Settings
    {
        ...
        {
            string entry = string.Format(format: "{0}:{1}", arg0: prefix, arg1: key);
