$(window).resize(function () {
    //Р·Р°СЂР°РґРё РјРµРЅСЋС‚Рѕ РєРѕРµС‚Рѕ СЃРµ РїСЂРµРјР°С…РІР° РЅР° РјР°Р»СЉРє РµРєСЂР°РЅ   
    setTimeout(function () {
        resizeCharts();
        resizeGrids();
    }, 1);
...
$(document).ready(function docReady() {
    //РўРѕРІР° СЃРєСЂРёРІР° Р»СЏРІРѕС‚Рѕ РјРµРЅСЋ РєР°С‚Рѕ СЃРµ Р·Р°СЂРµРґРё РЅР°С‡Р°Р»РЅР°С‚Р° СЃС‚СЂР°РЅРёС†Р°
...
$(window).ready(function myfunction() {
    //Р·Р°СЂР°РґРё РјРµРЅСЋС‚Рѕ РєРѕРµС‚Рѕ СЃРµ РїСЂРµРјР°С…РІР° РЅР° РјР°Р»СЉРє РµРєСЂР°РЅ. Р’Р°Р¶РЅРѕ Рµ РґР° Рµ РѕРєРѕР»Рѕ 200, Р·Р°С‰РѕС‚Рѕ Р»СЏРІРѕС‚Рѕ РјРµРЅСЋ СЃРµ СЃРєСЂРёРІР° СЃР»РµРґ РѕРїСЂРµРґРµР»РµРЅРѕ РІСЂРµРјРµ Рё С‚Рѕ С‚СЂСЏР±РІР° РґР° РјРёРЅРµ Р·Р° РґР° СЃРµ РїСЂРµРЅР°С‡РµСЂС‚Р°Рµ РіСЂР°С„РёРєР°С‚Р° РѕС‚РЅРѕРІРѕ
    setTimeout(function () {
        resizeCharts();
        resizeGrids();
    }, 200);
   ...
   , 200);
    ...
    $("div.hide-menu").click(function () {
        setTimeout(function () {
            resizeCharts();
            resizeGrids();
        }, 300); // РІР°Р¶РµРЅ Рµ С‚РѕР·Рё timeout 300
        }
    ...
    //    // РўСѓРє СЃРєСЂРёРІР°РјРµ Рё СЃР»РµРґ С‚РѕРІР° РїРѕРєР°Р·РІР°РјРµ РЅСЏРєРѕРё С‡Р°СЃС‚Рё, РєРѕРёС‚Рѕ РїСЂРµС‡Р°С‚ РЅР° С…СѓР±Р°РІРѕ РіРµРЅРµСЂРёСЂР°РЅ РµРєСЃРїРѕСЂС‚
    //    $("#divFooter").hide();
